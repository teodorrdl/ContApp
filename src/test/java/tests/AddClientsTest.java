...
public class AddClientsTest extends BasePage {
    ...
    @Test(description = "Successfully new client added")
    @Parameters ({"clientName","cuiOrCif", "registerNumber", "entity", "name", "deadline", "iban", "bankName", "country", "county", "city", "adress", "currency", "conctactPersonName", "email", "phone", "website"})
    public void addClient(String clientName, String cuiOrCif, String registerNumber, String entity, String name, String deadline, String iban, String bankName, String country, String county, String city, String adress, String currency, String conctactPersonName, String email, String phone, String website) throws InterruptedException {
        ...
        addNewClient().selectClientTable(clientName);
    }
    ...
    @Test(description = "Checking if it appears a popup with successful client added")
    @Parameters ({"cuiOrCif", "registerNumber", "entity", "name", "deadline", "iban", "bankName", "country", "county", "city", "adress", "currency", "conctactPersonName", "email", "phone", "website"})
    public void verifiedSavedClient(String cuiOrCif, String registerNumber, String entity, String name, String deadline, String iban, String bankName, String country, String county, String city, String adress, String currency, String conctactPersonName, String email, String phone, String website){
        ...
        addNewClient().addContactPersonWebsiteField(website);
        addNewClient().selectSaveButton();
        addNewClient().succesClientAddedPopup();
    }
